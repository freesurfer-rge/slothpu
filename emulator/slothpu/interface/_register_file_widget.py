...
class RegisterFileWidget(urwid.WidgetWrap):
    def __init__(self, register_file: RegisterFile):
        ...
        self._register_output = [
            urwid.Text("") for i in range(len(self._rf.registers))
        ]
        ...
        reg_box = urwid.LineBox(text_pile, title="Register File", title_align=urwid.LEFT)
        self.update()
    ...
    def update(self):
        ...
        self._B_text.set_text( self.format_regX_string('B', self._rf.B_register, self._rf.write_B_register))
        self._C_text.set_text( self.format_regX_string('C', self._rf.C_register, self._rf.write_C_register))
    ...
    def format_regX_string(self, reg_id:str, reg_idx:int, write_register: bool = False):
